...
pub trait Codec {
    ...
    ///
    /// # Errors
    /// Implementations fail if the value cannot be encoded in this codec's format.
    ...
    ///
    /// # Errors
    /// Implementations fail if the payload is not a value of the requested type in this codec's
    /// format.
