    ...
    Self: Send + Sync + 'static,
{
    ...
    ///
    /// # Errors
    /// Implementations fail if the message cannot be serialized in this codec's format.
    ...
    ///
    /// # Errors
    /// Implementations fail if the payload is not one message in this codec's format, or if
    /// `visit` fails.
